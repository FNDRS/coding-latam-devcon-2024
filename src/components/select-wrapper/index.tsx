...
import { Controller, FieldErrorsImpl, FieldValues } from "react-hook-form";
          ...
          <Select.Root onValueChange={field.onChange} value={field.value}>
            ...
            <Select.Portal>
              <Select.Content className="overflow-hidden bg-white rounded-md z-50 shadow-lg shadow-black/20">
                <Select.ScrollUpButton className="flex items-center justify-center h-6 bg-white text-black" />
                ...
                <Select.ScrollDownButton className="flex items-center justify-center h-6 bg-white text-black" />
              </Select.Content>
            </Select.Portal>
          </Select.Root>
        )}
